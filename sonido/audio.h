 ...
 */
 ...
 /*
 *  Fuente: https://github.com/jakebesworth/Simple-SDL2-Audio
 */
 ...
 *
 * @return returns a nuevo Audio or NULL on failure, you must call freeAudio() on return Audio
 *
 */
...
/*
 * Plays a nuevo music, only 1 at a time plays
 *
